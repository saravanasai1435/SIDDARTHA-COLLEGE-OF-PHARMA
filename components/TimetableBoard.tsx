...
const TimetableBoard: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 md:py-12">
      <div className="glass rounded-[3rem] p-6 md:p-12 shadow-2xl border border-emerald-50">
        
        {/* Institutional Document Header */}
        <header className="mb-8 text-center border-b border-emerald-100/70 pb-8">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 bg-emerald-100/70 rounded-full text-[10px] font-black uppercase tracking-widest text-emerald-900 mb-3 shadow-xs">
            <i className="fa-solid fa-graduation-cap text-emerald-700"></i>
            KVSRSCOPS / ACD / TT • OFFICIAL TIMETABLE
          </div>

          <h1 className="text-xl md:text-3xl font-black text-emerald-950 tracking-tight">
            KVSR SIDDHARTHA COLLEGE OF PHARMACEUTICAL SCIENCES
          </h1>
          <p className="text-[11px] md:text-xs font-bold text-slate-500 uppercase tracking-widest mt-1">
          ...
          {viewMode === 'class' && selectedClass ? (
            <div className="mt-5 max-w-4xl mx-auto bg-gradient-to-r from-emerald-50/90 via-slate-50 to-emerald-50/90 p-4 rounded-2xl border border-emerald-100/80 shadow-xs">
              <div className="flex flex-wrap justify-center items-center gap-3 text-xs font-bold">
              ...
              {selectedClass.incharge && (
                <div className="mt-3 flex flex-wrap justify-center items-center gap-2 text-[11px] font-bold text-emerald-800">
            ...
            <div className="mt-5 max-w-3xl mx-auto bg-gradient-to-r from-emerald-50/90 via-slate-50 to-emerald-50/90 p-4 rounded-2xl border border-emerald-100/80 shadow-xs">
              <div className="flex flex-wrap justify-center items-center gap-3 text-xs font-bold">
                <span className="px-3 py-1 bg-emerald-600 text-white rounded-xl shadow-xs">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center mb-8 gap-6">
          <div>
            <h2 className="text-2xl font-black text-emerald-950 tracking-tight">Institutional Timetable</h2>
            <p className="text-xs font-bold text-emerald-600 uppercase tracking-widest mt-0.5">
              {viewMode === 'class' ? 'Classroom Schedule Matrix' : 'Faculty Individual Workload Matrix'}
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {displaySlots.map(slot => {
            ...
            return (
              <div 
                key={slot.id} 
                className={`p-6 md:p-7 rounded-[2rem] bg-white border shadow-xs hover:shadow-md transition-all group relative overflow-hidden flex flex-col justify-between ${
